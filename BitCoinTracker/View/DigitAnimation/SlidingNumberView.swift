...
public class SlidingNumberView: UIView {
    ...
    private var fromNumber: String! = "00000"
    private var toNumber: String! = "00000"
    ...
    public init(startNumber: String,
         endNumber: String,
         font: UIFont? = UIFont.systemFont(ofSize: 60)) {
...
//            print(isShrinking)
            ...
            labelStackView.labelColor = textColor
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.layer.masksToBounds = true
        self.counterFont = UIFont.systemFont(ofSize: 60)
        initializeStackViews()
        self.layoutIfNeeded()
    }
}
